...
$sql = "SELECT min(auxin) as minsize, max(auxin) as maxsize FROM upload WHERE userid ='$id' and treatment='$treatment' and type='$type' and cytokininname='$kinintype'";  
...
$sql = "SELECT min(cytokinin) as minsize, max(cytokinin) as maxsize FROM upload WHERE userid ='$id' and treatment='$treatment' and type='$type' and cytokininname='$kinintype'";  
$result2=mysqli_query($connection,$sql);
$row = mysqli_fetch_assoc($result2);
$minsize = $row['minsize'];
$maxsize = $row['maxsize'];
...
$sql0 = "select (COUNT(auxin)) as n1, (COUNT(auxin)) as n2 from upload WHERE userid ='$id' and treatment='$treatment' and type='$type' and cytokininname='$kinintype'";  
...
$sql0 = "select (sum(auxin)) as sumx1,(sum(cytokinin)) as sumx2, (sum(response)) as sumresponse from upload WHERE userid ='$id' and treatment='$treatment' and type='$type' and cytokininname='$kinintype'";  
$result=mysqli_query($connection,$sql0);
while($rows=mysqli_fetch_array($result))
{
	 $sumx1=$rows['sumx1'];
...
$response_responsebarsum = 0;
 ...
 $sql6 = "select auxin,cytokinin,response from upload WHERE userid ='$id' and treatment='$treatment' and type='$type'";  
